...
pub fn count(mut file: impl BufRead) -> GenericResult<FileInfo> {
    let mut num_lines = 0;
    let mut num_words = 0;
    let mut num_bytes = 0;
    let mut num_chars = 0;
...
mod tests {
    ...
    #[test]
    fn test_count() {
        let text = "I don't know half of you half as well as I should like; and I like less than half of you half as well as you deserve.";
